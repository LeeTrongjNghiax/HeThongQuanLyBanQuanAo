...
'Yame', 'Việt Nam', 'Y Original', '0287307144', 'cskh@yame.vn', 'Việt Nam', '', 'AT', 'NV001')
...
'Yame', 'Việt Nam', 'Y Original', '0287307144', 'cskh@yame.vn', 'Việt Nam', '', 'ASM','NV001')
...
'Yame', 'Việt Nam', 'Y Original', '0287307141', 'cskh@yame.vn', 'Việt Nam','','AT','NV001')
...
'Yame', 'Việt Nam', 'Y Original', '0287301441', 'cskh@yame.vn', 'Việt Nam', '', 'QT', 'NV001')
...
'Yame', 'Việt Nam', 'Y Original', '0273071441', 'cskh@yame.vn', 'Việt Nam', '', 'QJ', 'NV001')
...
'Yame', 'Việt Nam', 'Y Original', '0873071441', 'cskh@yame.vn', 'Việt Nam', '', 'AK', 'NV002')
...
'Yame', 'Việt Nam', 'Y Original', '0287307141', 'cskh@yame.vn', 'Việt Nam', '', 'AK', 'NV002')
...
'Yame', 'Việt Nam', 'Y Original', '0283071441', 'cskh@yame.vn', 'Việt Nam', '', 'QS', 'NV002')
...
'Yame', 'Việt Nam', 'Y Original', '0280978900', 'cskh@yame.vn', 'Việt Nam', '', 'AT', 'NV002')

INSERT INTO ChiTietSanPham(mauSac, kichCo, soLuong, giaNhap, maSanPham) VALUES
('trắng', 'S', 12, 123000, 'AT009'),
('trắng', 'M', 12, 123000, 'AT009'),
('trắng', 'L', 12, 123000, 'AT009'),
('vàng', 'S', 12, 123000, 'AT009'),
('vàng', 'M', 12, 123000, 'AT009'),
('vàng', 'L', 12, 123000, 'AT009'),
('hồng', 'S', 12, 123000, 'AT009'),
('hồng', 'M', 12, 123000, 'AT009'),
('hồng', 'L', 11, 123000, 'AT009'),
('nâu', 'S', 12, 123000, 'AT009'),
('nâu', 'M', 12, 123000, 'AT009'),
('nâu', 'L', 12, 123000, 'AT009')

INSERT INTO SanPham VALUES
('QS011', 'Quần Short Thần Cổ Đại Aides Ver1', 'Cotton', 'short', 1, 'cái', 'Chất liệu: Jean Cotton\nThành phần: 100% cotton\n- Độ bền cao\n- Thoáng mát\n- Thoải mái\n+ Họa tiết khắc lazer\n+ logo TPR\n+ Wash thời trang',
'Yame', 'Việt Nam', 'Y Original', '0280978900', 'cskh@yame.vn', 'Việt Nam', '', 'QS', 'NV003')

INSERT INTO ChiTietSanPham(mauSac, kichCo, soLuong, giaNhap, maSanPham) VALUES
('xanh trang', 'S', 12, 199500, 'AT009'),
('xanh trang', 'M', 12, 199500, 'AT009'),
('xanh trang', 'L', 12, 199500, 'AT009'),
('xanh trang', 'XL', 12, 199500, 'AT009')
...
'Yame', 'Việt Nam', 'Y Original', '0280978900', 'cskh@yame.vn', 'Việt Nam', '', 'AT', 'NV003')

INSERT INTO ChiTietSanPham(mauSac, kichCo, soLuong, giaNhap, maSanPham) VALUES
('trang', 'S', 1, 250000, 'AT009'), 
('trang', 'M', 1, 250000, 'AT009'), 
('trang', 'L', 2, 250000, 'AT009'), 
('trang', 'XL', 2, 250000, 'AT009')
...
'Yame', 'Việt Nam', 'Y Original', '0280978900', 'cskh@yame.vn', 'Việt Nam', '', 'QD', 'NV003')

INSERT INTO ChiTietSanPham(mauSac, kichCo, soLuong, giaNhap, maSanPham) VALUES
('nau kem', 'S', 12, 397000, 'QD013'), 
('nau kem', 'M', 12, 397000, 'QD013'), 
('nau kem', 'L', 12, 397000, 'QD013')
...
'Yame', 'Việt Nam', 'Y Original', '0280978900', 'cskh@yame.vn', 'Việt Nam', '', 'ASM', 'NV003')

INSERT INTO ChiTietSanPham(mauSac, kichCo, soLuong, giaNhap, maSanPham) VALUES
('lam vang', 'S', 12, 457000, 'ASM014'), 
('lam vang', 'M', 12, 457000, 'ASM014'), 
('lam vang', 'L', 12, 457000, 'ASM014'), 
('lam vang', 'XL', 12, 457000, 'ASM014')

INSERT INTO SanPham VALUES
('ASM016', 'ÁO SƠ MI NỮ - TOTODAY - UPTOYOU', 'Cotton', '', 0, 'cái', '',
'Yame', 'Việt Nam', 'Y Original', '0280978900', 'cskh@yame.vn', 'Việt Nam', '', 'ASM', 'NV004')
...
'Yame', 'Việt Nam', 'Y Original', '0273072441', 'cskh@yame.vn', 'Việt Nam', '', 'QV', 'NV004')

INSERT INTO ChiTietSanPham(mauSac, kichCo, soLuong, giaNhap, maSanPham) VALUES
('đen', 'XS', 12, 336000, 'QV017'),
('đen', 'S', 12, 336000, 'QV017'),
('đen', 'M', 12, 336000, 'QV017'),
('đen', 'L', 12, 336000, 'QV008'),
...
'Yame', 'Việt Nam', 'Y Original', '0283071441', 'cskh@yame.vn', 'Việt Nam', '', 'DSN', 'NV004')

INSERT INTO ChiTietSanPham(mauSac, kichCo, soLuong, giaNhap, maSanPham) VALUES
('đen', 'XS', 20, 264000, 'D018'),
('đen', 'S', 20, 264000, 'D018'),
('đen', 'M', 20, 264000, 'D018'),
('đen', 'L', 20, 264000, 'D018'),
('đen', 'XL', 0, 264000, 'D018'),
('hồng', 'XS', 0, 264000, 'D018'),
('hồng', 'S', 0, 264000, 'D018'),
('hồng', 'M', 0, 264000, 'D018'),
('hồng', 'L', 0, 264000, 'D018'),
('hồng', 'XL', 0, 264000, 'D018')
...
'Yame', 'Việt Nam', 'Y Original', '0283071441', 'cskh@yame.vn', 'Việt Nam', '', 'QJ', 'NV004')
...
'Yame', 'Việt Nam', 'Y Original', '0283071441', 'cskh@yame.vn', 'Việt Nam', '', 'CV', 'NV004')
...
'HNOSS', 'Việt Nam', 'HNOSS', '0305880944', 'hnoss@yame.vn', 'Việt Nam', '', 'VQ', 'NV004')
...
'HNOSS', 'Việt Nam', 'HNOSS', '0305880944', 'hnoss@yame.vn', 'Việt Nam', '', 'JS', 'NV004')
...
'HNOSS', 'Việt Nam', 'HNOSS', '0305880944', 'hnoss@yame.vn', 'Việt Nam', '', 'DD', 'NV004')
...
'HNOSS', 'Việt Nam', 'HNOSS', '0305880944', 'hnoss@yame.vn', 'Việt Nam', '', 'DB', 'NV004')
...
'HNOSS', 'Việt Nam', 'HNOSS', '0305880944', 'hnoss@yame.vn', 'Việt Nam', '', 'QS', 'NV004')

INSERT INTO ChiTietSanPham(mauSac, kichCo, soLuong, giaNhap, maSanPham) VALUES
('den', 'S', 23, 391000, 'DB025'),
